  ...
  opts = function()
    ...
    local custom_components = {
      ...
      asyncrun_status = function()
        ...
        end, vim.tbl_extend('keep', vim.g.asyncrun_job_status or {}, { ['vimtex'] = _G.vimtex_jobs }, {}))))
      ...
      gitobject_bufname = (function()
        ...
        return function()
          ...
          elseif type(vim.b.git_sha) == 'string' then
            ...
            return (hl[revname or ''] or hl.commit)
              .. git_icon
              .. vim.b.git_sha:sub(1, 8)
